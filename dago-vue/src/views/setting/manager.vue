<template>
  <div class="setting-manager">
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="计数器" props="number">
      ...
      <el-form-item label="select2" props="select">
        <el-select
      ...
      <el-form-item label="即时配送" prop="delivery">
        <el-switch  v-model="ruleForm.delivery" on-color="#13ce66" off-color="#ff4949"></el-switch>
      </el-form-item>
