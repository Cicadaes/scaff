...
public class Application_bak {
	private static final Logger LOGGER = LoggerFactory.getLogger(Application_bak.class);
	private static Application_bak app = null;
	...
	private void start() throws Exception {
		...
		ApplicationContext ctx = SpringApplication.run(Application_bak.class, args);
