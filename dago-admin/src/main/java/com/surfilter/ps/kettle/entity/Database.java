...
public class Database implements Serializable {
	...
	public boolean equals(Object that) {
		...
		return (this.getIdDatabase() == null ? other.getIdDatabase() == null
				: this.getIdDatabase().equals(other.getIdDatabase()))
				&& (this.getName() == null ? other.getName() == null : this.getName().equals(other.getName()))
				&& (this.getIdDatabaseType() == null ? other.getIdDatabaseType() == null
						: this.getIdDatabaseType().equals(other.getIdDatabaseType()))
				&& (this.getIdDatabaseContype() == null ? other.getIdDatabaseContype() == null
						: this.getIdDatabaseContype().equals(other.getIdDatabaseContype()))
				...
				&& (this.getServername() == null ? other.getServername() == null
						: this.getServername().equals(other.getServername()))
				&& (this.getDataTbs() == null ? other.getDataTbs() == null
						: this.getDataTbs().equals(other.getDataTbs()))
				&& (this.getIndexTbs() == null ? other.getIndexTbs() == null
						: this.getIndexTbs().equals(other.getIndexTbs()))
				&& (this.getDatabaseName() == null ? other.getDatabaseName() == null
						: this.getDatabaseName().equals(other.getDatabaseName()));
	}
