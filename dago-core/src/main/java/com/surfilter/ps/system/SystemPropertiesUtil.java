package com.surfilter.ps.system;
 ...
 * 关于系统Properties的工具类
 * 
 * 1. 统一的读取系统变量，其中Boolean.readBoolean的风格不统一，Double则不支持，都进行了扩展. 2.
 * 简单的合并系统变量(-D)，环境变量 和默认值，以系统变量优先，在未引入Commons Config时使用. 3. Properties
